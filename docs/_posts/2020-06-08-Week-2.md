...
the function checkout_out does not return an string directly that is why we are having this error.
...
- [Keras](https://github.com/keras-team/keras-io/pull/83)
- [Tensorflow](https://github.com/tensorflow/agents/pull/391)
